export const en = {
  ...
  'settings.general.thinkingTitle': 'Thinking',
  'settings.general.thinkingDescription': 'Controls thinking token output for compatible reasoning models.',
  'settings.general.thinkingEnabled': 'Always Enable Thinking',
  'settings.general.thinkingHint': 'When enabled, thinking tokens are always requested from the model.',
  'settings.general.webSearchTitle': 'Web Search',
  'settings.general.webSearchDescription': 'Configure web search providers and API keys.',
  'settings.general.webSearchMode': 'Search Mode',
  'settings.general.webSearchModeAuto': 'Auto',
  'settings.general.webSearchModeAnthropic': 'Anthropic Native',
  'settings.general.webSearchModeTavily': 'Tavily',
  'settings.general.webSearchModeBrave': 'Brave',
  'settings.general.webSearchModeDisabled': 'Disabled',
  'settings.general.tavilyApiKey': 'Tavily API Key',
  'settings.general.braveApiKey': 'Brave Search API Key',
  'settings.general.webSearchHint': 'Anthropic native search is available when using the Anthropic API provider.',
  'settings.general.webSearchTavilyKey': 'API Key',
  'settings.general.webSearchBraveKey': 'API Key',
  'settings.general.webSearchGetApiKey': 'Get API Key',
  'settings.general.webSearchFreeTier': 'Free tier available',

  // Settings > Diagnostics
  'settings.diagnostics.title': 'Diagnostics',
  'settings.diagnostics.description': 'View and export diagnostic information for troubleshooting.',
  'settings.diagnostics.refresh': 'Refresh',
  'settings.diagnostics.totalSize': 'Total Size',
  ...
  'settings.diagnostics.retentionValue': '{days}d / {size} max',
  'settings.diagnostics.logDirectory': 'Log Directory',
  'settings.diagnostics.openDirectory': 'Open Folder',
  'settings.diagnostics.export': 'Export',
  'settings.diagnostics.exportBundle': 'Export Bundle',
  'settings.diagnostics.exported': 'Diagnostics exported to {file}',
  'settings.diagnostics.exportFailed': 'Failed to export diagnostics',
  'settings.diagnostics.loadFailed': 'Failed to load diagnostics',
  'settings.diagnostics.openFailed': 'Failed to open log directory',
  'settings.diagnostics.copySummary': 'Copy Summary',
  'settings.diagnostics.summaryCopied': 'Error summary copied to clipboard',
  'settings.diagnostics.copyFailed': 'Failed to copy to clipboard',
  'settings.diagnostics.noRecentErrors': 'No recent errors to copy',
  'settings.diagnostics.clear': 'Clear',
  ...
  'settings.diagnostics.confirmClear': 'Are you sure you want to clear all diagnostics data?',
  'settings.diagnostics.recentEvents': 'Recent Events',
  'settings.diagnostics.privacyNote': 'Diagnostics data stays on your machine unless you explicitly export it.',
