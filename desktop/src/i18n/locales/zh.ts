...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.general.thinkingTitle': '思考过程',
  'settings.general.thinkingDescription': '控制兼容推理模型的思考 token 输出。',
  'settings.general.thinkingEnabled': '始终启用思考',
  'settings.general.thinkingHint': '启用后，始终向模型请求思考 token。',
  'settings.general.webSearchTitle': '网络搜索',
  'settings.general.webSearchDescription': '配置网络搜索服务商和 API 密钥。',
  'settings.general.webSearchMode': '搜索模式',
  'settings.general.webSearchModeAuto': '自动',
  'settings.general.webSearchModeAnthropic': 'Anthropic 原生',
  'settings.general.webSearchModeTavily': 'Tavily',
  'settings.general.webSearchModeBrave': 'Brave',
  'settings.general.webSearchModeDisabled': '禁用',
  'settings.general.tavilyApiKey': 'Tavily API 密钥',
  'settings.general.braveApiKey': 'Brave Search API 密钥',
  'settings.general.webSearchHint': '使用 Anthropic API 服务商时可使用 Anthropic 原生搜索。',
  'settings.general.webSearchTavilyKey': 'API 密钥',
  'settings.general.webSearchBraveKey': 'API 密钥',
  'settings.general.webSearchGetApiKey': '获取 API 密钥',
  'settings.general.webSearchFreeTier': '提供免费套餐',

  // Settings > Diagnostics
  'settings.diagnostics.title': '诊断',
  'settings.diagnostics.description': '查看和导出诊断信息以进行故障排除。',
  'settings.diagnostics.refresh': '刷新',
  'settings.diagnostics.totalSize': '总大小',
  'settings.diagnostics.events': '事件数',
  'settings.diagnostics.recentErrors': '近期错误',
  'settings.diagnostics.retention': '保留策略',
  'settings.diagnostics.retentionValue': '{days}天 / 最大{size}',
  'settings.diagnostics.logDirectory': '日志目录',
  'settings.diagnostics.openDirectory': '打开文件夹',
  'settings.diagnostics.export': '导出',
  'settings.diagnostics.exportBundle': '导出诊断包',
  'settings.diagnostics.exported': '诊断已导出到 {file}',
  'settings.diagnostics.exportFailed': '导出诊断失败',
  'settings.diagnostics.loadFailed': '加载诊断信息失败',
  'settings.diagnostics.openFailed': '打开日志目录失败',
  'settings.diagnostics.copySummary': '复制摘要',
  'settings.diagnostics.summaryCopied': '错误摘要已复制到剪贴板',
  'settings.diagnostics.copyFailed': '复制到剪贴板失败',
  'settings.diagnostics.noRecentErrors': '没有最近的错误可复制',
  'settings.diagnostics.clear': '清除',
  'settings.diagnostics.clearLogs': '清除日志',
  'settings.diagnostics.cleared': '诊断数据已清除',
  'settings.diagnostics.clearFailed': '清除诊断数据失败',
  'settings.diagnostics.confirmClear': '确定要清除所有诊断数据吗？',
  'settings.diagnostics.recentEvents': '最近事件',
  'settings.diagnostics.privacyNote': '诊断数据仅保留在本地，除非你主动导出。',
  ...
  'permMode.label.bypassPermissions': '跳过权限',
